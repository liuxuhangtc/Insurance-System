 ...
 * @author xuhang
 */
public class ManagerEditMessageView extends javax.swing.JFrame {
	 ...
	 */
	public ManagerEditMessageView(InsuranceCompanyManagerUser user,InsuranceSystem system) {
	...
	private void initTable(InsuranceCompanyManagerUser user){
		...
		row[2] = user.getManagerName();
		row[3] = user.getManagerCompany();
		model.addRow(row);
	}
	...
	private void initComponents(JPanel jPanel) {
		...
		planListTable.setModel(new javax.swing.table.DefaultTableModel(
				...
				new String [] {
						"Username", "Password", "Company Location", "Company Name"
				}
				) {
		...
		update.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String managerName = String.valueOf(userModel.getValueAt(0, 2));
				String CompanyName = String.valueOf(userModel.getValueAt(0, 3));
				InsuranceCompanyManagerUser cu = (InsuranceCompanyManagerUser)system.getUserAccountDirectory().findUserByUsername(system.getCurrentUser().getUsername());
				cu.setPassword(password);
				cu.setManagerName(managerName);
				cu.setManagerCompany(CompanyName);
