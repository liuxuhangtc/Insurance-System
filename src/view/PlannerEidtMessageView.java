 ...
 * @author xuhang
 */
public class PlannerEidtMessageView extends javax.swing.JFrame {
	 ...
	 */
	public PlannerEidtMessageView(InsuranceCompanyUser user,InsuranceSystem system) {
	...
	private void initTable(InsuranceCompanyUser user){
		...
		row[2] = user.getPlannerCompany();
		row[3] = user.getPlannerName();
		model.addRow(row);
	}
	...
	private void initComponents(JPanel jPanel) {
		...
		planListTable.setModel(new javax.swing.table.DefaultTableModel(
				...
				new String [] {
						"Username", "Password", "Planner Company", "Planner Name"
				}
				) {
		...
		update.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String PlannerCompany = String.valueOf(userModel.getValueAt(0, 2));
				String PlannerName = String.valueOf(userModel.getValueAt(0, 3));
				System.out.println("system=="+system.getCurrentUser());
                   System.out.println("user==="+system.getCurrentUser().getUsername());
                   for(UserAccount user:system.getUserAccountDirectory().getUserAccountList()) {
                	   System.out.println("name=="+user.getUsername());
                   }
				InsuranceCompanyUser cu = (InsuranceCompanyUser)system.getUserAccountDirectory().findUserByUsername(system.getCurrentUser().getUsername());
				cu.setPassword(password);
				cu.setPlannerCompany(PlannerCompany);
				cu.setPlannerName(PlannerName);
